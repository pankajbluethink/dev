  ...
  renderSearch = () => {
    ...
    return (
      <Block center flex={0.06} style={styles.header}>
        ...
        <Text size={25} color="#606560" style={{fontWeight:"bold"}}>  Stats</Text>
        <Text size={20} color="#606560" style={{fontWeight:"bold"}}>Amount deu: 0$</Text>
        <Text size={20} color="#606560" style={{fontWeight:"bold",}}>Total Orders delivered: 2</Text>
      </Block>
      // <Input
      //   right
      //   color="black"
